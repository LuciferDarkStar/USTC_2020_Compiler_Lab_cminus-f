...
int main() {
	...
	auto mul=builder->create_imul(aLoad,CONST_INT(2));//得到 of a*2
	builder->create_store(mul,retAlloca);//存储返回值
	auto retLoad=builder->create_load(retAlloca);//load返回值 
